...
namespace brewjournal.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20200627032841_add-brewjournal-entities")]
    partial class addbrewjournalentities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("brewjournal.Domain.Entities.Batch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("brewjournal.Domain.Entities.BatchHopAdditions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("brewjournal.Domain.Entities.BatchSample", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("brewjournal.Domain.Entities.TodoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("brewjournal.Domain.Entities.TodoList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("brewjournal.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("brewjournal.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("brewjournal.Domain.Entities.Batch", b =>
                {
                    b.HasOne("brewjournal.Domain.Entities.Recipe", "Recipe")
                        .WithMany()
            ...
            modelBuilder.Entity("brewjournal.Domain.Entities.BatchHopAdditions", b =>
                {
                    b.HasOne("brewjournal.Domain.Entities.Batch", "Batch")
            ...
            modelBuilder.Entity("brewjournal.Domain.Entities.BatchSample", b =>
                {
                    b.HasOne("brewjournal.Domain.Entities.Batch", null)
                        .WithMany("Samples")
                        .HasForeignKey("BatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("brewjournal.Domain.Entities.TodoItem", b =>
                {
                    b.HasOne("brewjournal.Domain.Entities.TodoList", "List")
                        .WithMany("Items")
